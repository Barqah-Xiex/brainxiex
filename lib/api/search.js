...
module.exports = function (config) {
  ...
  return {
    ...
    pinterest: (search) =>
      axios
        .post(`${BASE}/api/search/pinterest`, { apikey, search })
    ...
    google: (search) =>
      axios
        .post(`${BASE}/api/search/google`, { apikey, search })
        .then((res) => res?.data?.Barqah || res?.data)
        .catch((err) => ({ error: err.message })),
    ...
    youtubeSearch: (search) =>
      axios
        .post(`${BASE}/api/search/youtube`, { apikey, search })
        .then((res) => res?.data?.Barqah || res?.data)
        .catch((err) => ({ error: err.message })),
    ...
    yts: (search) =>
      axios
        .post(`${BASE}/api/search/yts`, { apikey, search })
        .then((res) => res?.data?.Barqah || res?.data)
        .catch((err) => ({ error: err.message })),
  };
};
