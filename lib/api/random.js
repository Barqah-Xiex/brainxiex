...
module.exports = function (config) {
  ...
  return {
    ...
    apakah: (ask) =>
      axios
        .post(baseURL + 'apakah', { ask, apikey })
    ...
    bisakah: (ask) =>
      axios
        .post(baseURL + 'bisakah', { ask, apikey })
        .then((res) => res?.data?.Barqah || res?.data)
        .catch((err) => ({ error: err.message })),
    ...
    citacita: (ask) =>
      axios
        .post(baseURL + 'citacita', { ask, apikey })
        .then((res) => res?.data?.Barqah || res?.data)
        .catch((err) => ({ error: err.message })),
    ...
    gombal: (ask) =>
      axios
        .post(baseURL + 'gombal', { ask, apikey })
        .then((res) => res?.data?.Barqah || res?.data)
        .catch((err) => ({ error: err.message })),
    ...
    katamutiara: (ask) =>
      axios
        .post(baseURL + 'katamutiara', { ask, apikey })
        .then((res) => res?.data?.Barqah || res?.data)
        .catch((err) => ({ error: err.message })),
    ...
    tebakan: (ask) =>
      axios
        .post(baseURL + 'tebakan', { ask, apikey })
        .then((res) => res?.data?.Barqah || res?.data)
        .catch((err) => ({ error: err.message })),
