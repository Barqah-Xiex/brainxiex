...
module.exports = function (config) {
  ...
  return {
    ...
    tebakgambar: () =>
      axios
        .post(baseURL + 'tebakgambar', { apikey })
        .then((res) => res?.data?.Barqah || res?.data)
        .catch((err) => ({ error: err.message })),
    ...
    caklontong: () =>
      axios
        .post(baseURL + 'caklontong', { apikey })
        .then((res) => res?.data?.Barqah || res?.data)
        .catch((err) => ({ error: err.message })),
    ...
    siapakahaku: () =>
      axios
        .post(baseURL + 'siapakahaku', { apikey })
        .then((res) => res?.data?.Barqah || res?.data)
        .catch((err) => ({ error: err.message })),
    ...
    tebakbendera: () =>
      axios
        .post(baseURL + 'tebakbendera', { apikey })
        .then((res) => res?.data?.Barqah || res?.data)
        .catch((err) => ({ error: err.message })),
    ...
    tebakkalimat: () =>
      axios
        .post(baseURL + 'tebakkalimat', { apikey })
        .then((res) => res?.data?.Barqah || res?.data)
        .catch((err) => ({ error: err.message })),
    ...
    tebakkimia: () =>
      axios
        .post(baseURL + 'tebakkimia', { apikey })
        .then((res) => res?.data?.Barqah || res?.data)
        .catch((err) => ({ error: err.message })),
    ...
    tebaklirik: () =>
      axios
        .post(baseURL + 'tebaklirik', { apikey })
        .then((res) => res?.data?.Barqah || res?.data)
        .catch((err) => ({ error: err.message })),
    ...
    tebaktebakan: () =>
      axios
        .post(baseURL + 'tebaktebakan', { apikey })
        .then((res) => res?.data?.Barqah || res?.data)
        .catch((err) => ({ error: err.message })),
  };
};
